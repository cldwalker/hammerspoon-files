...
menuHammerMenuList = {
    ...
    [mainMenu] = {
        ...
        menuItems = {
            ...
            -- }},
            {cons.cat.submenu, '', 'L', 'Logseq', {
                 {cons.act.menu, logseqMenu}
            }},
    ...
    [logseqMenu] = {
        ...
        menuHotkey = nil,
        menuItems = {
            {cons.cat.action, '', 'C', 'Convert url to block', {
              {
                  cons.act.script,
                  "~/code/repo/bb-clis/bin/bb-logseq-convert"},
              }},
            {cons.cat.action, '', 'M', 'Move to page', {
              {
                  cons.act.script,
                  "~/code/repo/bb-clis/bin/bb-logseq-move-to-page"},
              }},
        }
    },
